...
%\rm{arg = -\frac{\overline{Eg}}{2kT} + \frac{1.1150877}{2\times 300.15}}\nonumber\\
...
%\rm{arg1 = -\frac{\overline{Eg}1}{2kT} + \frac{1.1150877}{2\times 300.15}}\nonumber\\
...
\noindent{\color{darkblue}\textbf{Junction capacitance variables :}}
...
\rm{\overline{tcjsw} = \ }
\rm{\overline{tcjsw}\times(1+\overline{mj}\times
...
\noindent{\color{darkblue}\textbf{Saturation current variables :}}
\begin{eqnarray}
...
\noindent{\color{darkblue}\textbf{Additional variables :}}
\begin{eqnarray}
...
\noindent{\color{darkblue}\textbf{Depletion capacitance variables :}}
\begin{eqnarray}
\rm{\overline{tCdep}=\overline{tjp}\times fc}\nonumber 								
\end{eqnarray}

\noindent{\color{darkblue}\textbf{Vcrit :}}
\begin{eqnarray}
\rm{vte = n\times vt}\nonumber \\		
\rm{tVcrit=vte\times \log\left(\frac{vte}{(\sqrt{2}\times \overline{tjs}\times area)}\right)}\nonumber 						
\end{eqnarray}

\noindent{\color{darkblue}\textbf{Transit time :}}
\begin{eqnarray}
\rm{\overline{ttt}=tt\times \left( 1+TTT1\times dt + TTT2\times dt^2 \right)}\nonumber 								
\end{eqnarray}

\noindent{\color{darkblue}\textbf{Series resistance :}}
\begin{eqnarray}
...
\noindent{\color{darkblue}\textbf{ DC Current :}}
...
\begin{array}{l l}
	\left\{
	\begin{array}{l l}	
	\rm{Isat\times(\exp(vd/vte)-1) + gmin\times vd\nonumber\hspace{0.1in}(ikf\leq 0)} \vspace{0.1in} \\ 
	...
	\end{array} 
	\right.\nonumber \hspace{0.2in} \rm{(-3\times vte\leq vd)}\\ \\
	\left\{
	\begin{array}{l l}	
	\rm{-Isat\times\left(1+\left(\frac{3\times vte}{e\times vd}\right)^3\right) + gmin\times vd\nonumber \hspace{0.2in}(ikr\leq 0)} \vspace{0.1in} \\
	...
	\end{array}
	\right.\nonumber \hspace{0.2in} \rm{(-BV \leq vd<-3\times vte)}\\	\\
	\left\{
	\begin{array}{l l}	
	\rm{-Isat\times\exp(-\frac{BV+vd}{vte}) + gmin\times vd\nonumber\hspace{0.35in}(ikr\leq 0)} \vspace{0.1in} \\
...
\clearpage
\noindent{\color{darkblue}\textbf{ Charge Storage :}}
...
\noindent{\color{darkblue}\textbf{ Capacitance :}}
